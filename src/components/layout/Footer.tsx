      ...
      <div className="container mx-auto py-6 sm:py-8 px-4 md:px-6">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="md:col-span-1">
            <h3 id="quick-links-heading" className="font-headline text-md sm:text-lg font-semibold mb-3">Quick Links</h3>
            <ul className="space-y-1.5 sm:space-y-2" aria-labelledby="quick-links-heading">
              <li><Link href="/about" className="text-xs sm:text-sm text-muted-foreground hover:text-primary transition-colors">About Us</Link></li>
              <li><Link href="/blog" className="text-xs sm:text-sm text-muted-foreground hover:text-primary transition-colors">Blog</Link></li>
              <li><Link href="/careers" className="text-xs sm:text-sm text-muted-foreground hover:text-primary transition-colors">Careers</Link></li>
              <li><Link href="/contact" className="text-xs sm:text-sm text-muted-foreground hover:text-primary transition-colors">Contact</Link></li>
              <li><Link href="/privacy-policy" className="text-xs sm:text-sm text-muted-foreground hover:text-primary transition-colors">Privacy Policy</Link></li>
            </ul>
          </div>
          <div className="md:col-span-1">
             <h3 className="font-headline text-md sm:text-lg font-semibold mb-3">Follow Us</h3>
