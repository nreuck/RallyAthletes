    ...
    <div className="bg-background py-10 sm:py-12 md:py-20">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <header className="text-center mb-10 md:mb-16">
          ...
          <h1 className="font-headline text-3xl sm:text-4xl md:text-5xl font-bold text-primary mb-4">ScoutMe Sports</h1>
        ...
        <section className="mb-10 md:mb-16">
          <Card className="shadow-lg">
            <CardHeader>
              <CardTitle className="font-headline text-xl sm:text-2xl">What is ScoutMe Sports?</CardTitle>
            </CardHeader>
