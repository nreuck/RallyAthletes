      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <header className="text-center mb-10 md:mb-16">
          <div className="inline-block p-3 sm:p-4 bg-primary/10 rounded-lg mb-4 sm:mb-6">
            <LayoutDashboard className="h-12 w-12 sm:h-16 sm:w-16 text-primary" />
          </div>
          <h1 className="font-headline text-3xl sm:text-4xl md:text-5xl font-bold text-primary mb-4">My Team Dashboard</h1>
        ...
        <section className="mb-10 md:mb-16">
          <Card className="shadow-lg">
            <CardHeader>
              <CardTitle className="font-headline text-xl sm:text-2xl">What is My Team Dashboard?</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-sm sm:text-base">
              ...
              <div className="relative h-56 sm:h-64 md:h-96 w-full my-6 rounded-lg overflow-hidden shadow-md">
                <Image
